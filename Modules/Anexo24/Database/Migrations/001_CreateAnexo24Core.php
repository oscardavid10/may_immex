<?php
namespace Modules\Anexo24\Database\Migrations;
use CodeIgniter\Database\Migration;
class CreateAnexo24Core extends Migration {
    public function up() {
        $forge = $this->forge;
        $forge->query("CREATE TABLE IF NOT EXISTS empresas (
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS unidades_medida (
          id INT AUTO_INCREMENT PRIMARY KEY,
          clave_sat VARCHAR(5) NOT NULL,
          descripcion VARCHAR(255) NOT NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
        $forge->query("CREATE TABLE IF NOT EXISTS fracciones (
          id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS productos (
          id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS pedimentos (
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS pedimentos_partidas (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS lotes (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS bom (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS mov_inventario (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
          id_empresa INT NOT NULL,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS expedientes_exportacion (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
          id_empresa INT NOT NULL,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS descargas_insumos (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
        ...
        $forge->query("CREATE TABLE IF NOT EXISTS alertas_plazo (
          id BIGINT AUTO_INCREMENT PRIMARY KEY,
